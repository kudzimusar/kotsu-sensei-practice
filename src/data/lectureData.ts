...
export const terminology: TerminologyItem[] = [
  ...
  { term: "Roadway", definition: "The portion of the road designed for vehicle traffic, excluding sidewalks and road shoulders.", category: "Road" },
  { term: "Sidewalk", definition: "Road portion divided by a curb, fence or guardrail for pedestrians.", category: "Road" },
  { term: "Road Shoulder", definition: "The edge portion of the roadway adjacent to the main traffic lanes.", category: "Road" },
  ...
  { term: "Centerline", definition: "Line marking the center of the roadway, dividing traffic in opposite directions.", category: "Road" },
  { term: "Road Edge Line", definition: "Line marking the outer edge of the roadway, separating it from the shoulder.", category: "Road" },
  { term: "Intersection", definition: "Roadway where side roads and roadways are divided.", category: "Road" },
  { term: "Crosswalk", definition: "Marked pathway for pedestrians to cross the roadway.", category: "Road" },
  { term: "Bicycle Crossing", definition: "Designated area for bicycles to cross the roadway.", category: "Road" },
  ...
  { term: "Acceleration Lane", definition: "Lane on expressway for vehicles to increase speed when merging into main traffic.", category: "Road" },
  { term: "Deceleration Lane", definition: "Lane on expressway for vehicles to reduce speed when exiting main traffic.", category: "Road" },
  { term: "Climbing Lane", definition: "Additional lane on uphill sections of expressways for slower vehicles.", category: "Road" },
  { term: "Safety Zone", definition: "Designated area on the roadway for pedestrian safety, especially near streetcar stops.", category: "Road" },
  { term: "Tunnel", definition: "Enclosed roadway passage through or under an obstacle.", category: "Road" },
  { term: "Level Crossing", definition: "Location where road intersects with railway tracks at the same level.", category: "Road" },
  ...
  { term: "Large Motor Vehicle", definition: "Motor vehicle with load capacity of 5,000 kg or more, or passenger capacity of 11 or more persons.", category: "Vehicle" },
  { term: "Medium Motor Vehicle", definition: "Motor vehicle with load capacity of 3,000 kg or more but less than 5,000 kg, or passenger capacity of 11 or more persons.", category: "Vehicle" },
  ...
  { term: "Regular Motor Vehicle", definition: "Motor vehicle that is not classified as large or medium.", category: "Vehicle" },
  { term: "Mini Car (Kei Car)", definition: "Regular motor vehicle with a total engine displacement of less than 660 cc, or with a motor that develops rated power of less than 0.66 kW.", category: "Vehicle" },
  { term: "Large Motorcycle", definition: "Motorcycles with total engine displacement of 400 cc or more.", category: "Vehicle" },
  { term: "Regular Motorcycle", definition: "Motorcycles with total engine displacement of 50 cc or more but less than 400 cc.", category: "Vehicle" },
  ...
  { term: "Moped", definition: "Two-wheeled vehicles with a total engine displacement of less than 50 cc.", category: "Vehicle" },
  ...
  { term: "Pedestrian", definition: "Person on foot, including those pushing a bicycle, wheelchair user, or child in a stroller.", category: "Driving" },
  ...
  { term: "Emergency Vehicle", definition: "Fire engines, ambulances, police cars, and other designated emergency response vehicles.", category: "Vehicle" },
  { term: "Trailer", definition: "Vehicle designed to be towed by a motor vehicle.", category: "Vehicle" },
  
  // Driving-related terms
  { term: "Driving", definition: "Operating or controlling the movement of a vehicle on a road.", category: "Driving" },
  { term: "Parking", definition: "Stopping a vehicle and leaving it unattended for more than a brief period.", category: "Driving" },
  { term: "Stopping", definition: "Bringing a vehicle to a halt, whether attended or unattended.", category: "Driving" },
  { term: "Temporary Stop", definition: "Bringing a vehicle to a complete halt before proceeding.", category: "Driving" },
  { term: "Yielding", definition: "Slowing down or stopping to give priority to other traffic.", category: "Driving" },
  { term: "Overtaking", definition: "Passing another vehicle traveling in the same direction.", category: "Driving" },
  { term: "Passing", definition: "Moving alongside or going by another vehicle or pedestrian.", category: "Driving" },
  { term: "Lane Change", definition: "Moving from one lane to another on a multi-lane roadway.", category: "Driving" },
  { term: "U-turn", definition: "Turning a vehicle 180 degrees to travel in the opposite direction.", category: "Driving" },
  { term: "Right Turn", definition: "Turning a vehicle to the right at an intersection or junction.", category: "Driving" },
  { term: "Left Turn", definition: "Turning a vehicle to the left at an intersection or junction.", category: "Driving" },
  { term: "Safe Speed", definition: "Operating speed that allows stopping within visible distance and avoiding danger.", category: "Driving" },
  { term: "Safe Distance", definition: "Maintaining adequate space between vehicles to allow for safe stopping.", category: "Driving" },
  { term: "Following Distance", definition: "Space maintained behind the vehicle ahead, sufficient for safe stopping.", category: "Driving" },
  { term: "Blind Spot", definition: "Area around a vehicle that cannot be directly observed by the driver.", category: "Driving" },
  { term: "Safety Confirmation", definition: "Checking surroundings using mirrors and direct observation before maneuvers.", category: "Driving" },
  { term: "Turn Signal", definition: "Device used to indicate intention to turn or change lanes.", category: "Driving" },
  { term: "Horn", definition: "Warning device used to alert other road users of vehicle presence.", category: "Driving" },
  { term: "Headlights", definition: "Front lighting system for visibility and being seen by others.", category: "Driving" },
  { term: "Hazard Lights", definition: "All turn signals flashing simultaneously to indicate emergency or hazard.", category: "Driving" },
  
  // Traffic Sign terms
  { term: "Regulatory Sign", definition: "Signs that indicate rules and regulations that must be followed.", category: "Signs" },
  { term: "Warning Sign", definition: "Signs that alert drivers to potential hazards ahead.", category: "Signs" },
  { term: "Instruction Sign", definition: "Signs that provide information and guidance to drivers.", category: "Signs" },
  { term: "Stop Sign", definition: "Regulatory sign requiring complete stop before proceeding.", category: "Signs" },
  { term: "Yield Sign", definition: "Sign requiring drivers to give priority to other traffic.", category: "Signs" },
  { term: "No Entry Sign", definition: "Sign prohibiting entry into a road or area.", category: "Signs" },
  { term: "No Parking Sign", definition: "Sign prohibiting parking in the designated area.", category: "Signs" },
  { term: "No Stopping Sign", definition: "Sign prohibiting both parking and stopping.", category: "Signs" },
  { term: "Speed Limit Sign", definition: "Sign indicating maximum permitted speed.", category: "Signs" },
  { term: "One-Way Sign", definition: "Sign indicating traffic may only travel in one direction.", category: "Signs" },
  { term: "School Zone Sign", definition: "Sign indicating area near schools requiring extra caution.", category: "Signs" },
  { term: "Pedestrian Crossing Sign", definition: "Sign indicating presence of pedestrian crossing ahead.", category: "Signs" },
  { term: "Traffic Light", definition: "Signal device using colored lights to control traffic flow.", category: "Signs" },
  { term: "Road Marking", definition: "Lines, symbols, and text painted on the roadway surface.", category: "Signs" },
];
